...
var Tabs = function () {
    ...
    _createClass(Tabs, [{
        ...
        key: 'hideInactiveTabs',
        value: function hideInactiveTabs() {
        ...
        value: function currentTab() {
            ...
            (0, _jquery2.default)('#' + current_tab_link_id).addClass('tabs--current-link');
            (0, _jquery2.default)('#' + current_tab_content_id).addClass('tabs--current-tab');
        }
    }]);
